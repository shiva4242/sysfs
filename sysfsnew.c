...
#define BUILD_BUG_ON_ZERO(e) (sizeof(struct {int:(-!!(e)); }))
   ...
   /*
    ...
    static struct kobj_attribute foo_attribute =__ATTR(foo, S_IRUGO | S_IWUGO, foo_show, foo_store);
    
    /*
   7  * More complex function where we determine which variable is being accessed by
